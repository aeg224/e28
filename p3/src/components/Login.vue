  ...
  <div>
    ...
    <form class="mx-1 px-1">
      ...
      <div class="form-group">
        ...
        >
        <small
          v-if="showCredentialError"
          id="errorMessage3"
          class="form-text text-danger"
          >{{ credentialError }}</small
        >
      </div>
    </form>
    <p class="card-text">Please Login or Register To Use The Application.</p>
    <button
      id="submitLogin"
      @click="checkLogin()"
      type="submit"
...
export default {
  ...
  methods: {
    // Calls validation methods. Sends request if client-side validation fails.
    checkLogin() {
